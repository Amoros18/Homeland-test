...
@section('content')
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({{ asset('assets/images/hero_bg_2.jpg')}}" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <h1 class="mb-2">{{$hometype}} Propreties</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section site-section-sm bg-light">
      <div class="container">
        ...
        @foreach ($propsByHomeType as $relateProp )
        ...
        <h3 class="alert alert-success"> they are not buy properties for this type home now</h3>
