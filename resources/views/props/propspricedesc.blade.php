...
@section('content')
    ...
    <div class="site-blocks-cover inner-page-cover overlay" style="background-image: url({{ asset('assets/images/hero_bg_2.jpg')}}" data-aos="fade" data-stellar-background-ratio="0.5">
      <div class="container">
        <div class="row align-items-center justify-content-center text-center">
          <div class="col-md-10">
            <h1 class="mb-2"> Propreties by price Descending</h1>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section site-section-sm bg-light">
      <div class="container">
        ...
        <div class="row">
          <div class="col-12">
            <div class="site-section-title mb-5">
              <h2>Propreties by price Descending</h2>
            </div>
          </div>
        </div>
        ...
        @foreach ($propsByPriceDesc as $relateProp )
        ...
        <h3 class="alert alert-success"> they are not buy properties for this now</h3>
