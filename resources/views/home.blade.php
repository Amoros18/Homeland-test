...
@section('content')
    <div class="">
        ...
        <div class="site-section site-section-sm pb-0">
            <div class="container">
                <div class="row">
                    <form action="{{route('search.props')}}" method="POST" class="form-search col-md-12" style="margin-top: -100px;">
                        @csrf
                    ...
                    <div class="col-md-12">
                        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
                            <div class="mr-auto">
                                ...
                                <a href="{{route('home')}}" class="icon-view view-list"><span
                            ...
                            <div class="ml-auto d-flex align-items-center">
                                <div>
                                    ...
                                    <a href="{{route('price.asc.prop')}}" class="view-list px-3 border-right">Price  Ascending</a>
                            ...
                            <div class="property-entry h-100">
                                ...
                                <div class="p-4 property-body">
                                    ...
                                    <span class="property-location d-block mb-3"><span
                                            class="property-icon icon-room"></span>{{ $prop->location }}</span>
                                    <strong
